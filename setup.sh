...
echo "🚀 Northstar Digital Lab 파일을 생성합니다..."

# 1. 디렉토리 생성 (현재 위치에 바로 생성)
mkdir -p app
mkdir -p public
...
export const metadata: Metadata = {
  title: "Northstar Digital Lab",
  description: "Build the Direction. Prove the Revenue.",
};
